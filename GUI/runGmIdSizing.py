...
class gmIdGUIWindow(QtWidgets.QMainWindow):
    ...
    def __init__( self):
        ...
        if sys.platform == 'win32':
            self.setWindowIcon(QtGui.QIcon(resource_path('gmId.ico')))
        else:
            self.setWindowIcon(QtGui.QIcon(resource_path('gmId.png')))
        # Initialize the Data
        self.configDataLib()
        # Threading
...
if __name__ == '__main__':
    ...
    app.setApplicationName('gmIdSizing')
    app.setDesktopFileName('gmIdSizing')
    form = gmIdGUIWindow()
    form.show()
    app.exec_()
