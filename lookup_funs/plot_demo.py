...
VDS = 0.9
VSB = 0
lengths = [0.18, 0.35, 0.6, 1.0, 2.0]  # µm
...
fig.suptitle(
    f"TSMC 180 nm nch  ({nch.CORNER.upper()} corner,  VDS={VDS} V,  VSB={VSB} V)",
    fontsize=14,
    y=0.98,
)
...
for L in lengths:
    ...
    ft[L] = lookup(nch, "FUG", "VGS", vgs, "VDS", VDS, "VSB", VSB, "L", L, WARNING="off") / 1e9
